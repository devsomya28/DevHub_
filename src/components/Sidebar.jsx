...
export default function Sidebar() {
  return (
    <div className="flex h-full w-64 flex-col border-r border-slate-800 bg-slate-900/50 backdrop-blur-xl">
      <div className="flex h-16 items-center gap-2 px-6">
        ...
        <span className="text-lg font-bold tracking-tight text-white">DevHub</span>
      </div>
